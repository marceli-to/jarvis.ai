<x-layout title="DB Admin – Jarvis" description="A lightweight, modern MySQL database administration tool. Browse databases, manage tables, edit data, and run SQL queries — all in a clean Flux UI interface.">
            ...
            <div class="mb-16 animate-slide-up delay-300">
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="https://github.com/marceli-to/dbadmin" target="_blank" class="badge badge-gradient transition-all group">
                            View on GitHub
                            <i class="ph ph-github-logo transition-transform group-hover:translate-x-0.5"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-y-24">
                ...
                <div class="animate-slide-up delay-800">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        <div class="bg-white/5 rounded-xl p-4 border border-white/[0.06]">
                            <h3 class="text-white mb-1">Livewire 4 + Volt</h3>
                        ...
                        <div class="bg-white/5 rounded-xl p-4 border border-white/[0.06]">
                            <h3 class="text-white mb-1">MySQL via Socket</h3>
